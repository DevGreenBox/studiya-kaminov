...
const steps: { icon: PencilIconName; title: string; text: string }[] = [
  {
    ...
    text: 'Добавьте камин в корзину и заполните форму оформления. Логин и регистрация не нужны.',
  },
  {
    icon: 'support',
    title: 'Дождитесь звонка менеджера',
    text: 'Менеджер подтвердит состав заказа, окончательную стоимость доставки и сроки отгрузки.',
  },
  {
    icon: 'truck',
    title: 'Получите камин',
    text: `Отправляем транспортной компанией «${deliveryConfig.carrier}» либо передаём при самовывозе.`,
  },
];
...
const faq = [
  {
    ...
    a: 'На странице оформления заказа укажите город получателя и нажмите «Рассчитать». Расчёт учитывает город, вес и габариты заказа. Это предварительная оценка — точную сумму подтверждает менеджер.',
  },
  {
    q: 'Нужен ли монтаж и дымоход?',
    a: 'Нет. Электрокамин подключается к обычной розетке 220 В. Дымоход, вытяжка и согласования не требуются.',
  },
  {
    q: 'В каком виде приезжает камин?',
    a: 'В заводских коробках. Большинство моделей поставляются в двух упаковках — портал и очаг, у моделей с тумбами упаковок больше. Крепёж и инструкция в комплекте.',
  },
  {
    q: 'Сложно ли собрать камин?',
    a: 'Сборка занимает около 10 минут по инструкции, специальный инструмент не нужен.',
  },
  {
    q: 'Можно ли забрать заказ самостоятельно?',
    a: 'Да, самовывоз со склада возможен. Дату и адрес согласует менеджер после оформления заказа.',
  },
];
    ...
    <>
      <div className="container-site py-6">
        ...
        <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-ink-soft sm:text-base">
          Отправляем электрокамины по всей России. Стоимость доставки считается при оформлении
          заказа — по городу получателя, весу и габаритам.
        </p>
        ...
        <section className="mt-14 grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="rounded-[var(--radius-md)] border border-line bg-surface p-6">
            <h2 className="text-xl font-bold">Доставка «{deliveryConfig.carrier}»</h2>
            <ul className="mt-4 flex list-disc flex-col gap-2.5 pl-5 text-[15px] leading-relaxed text-ink-soft">
              <li>Отправка по всей России до терминала или до адреса.</li>
              <li>Стоимость рассчитывается автоматически при оформлении заказа.</li>
              <li>Расчёт учитывает город получателя, вес и объём отправления.</li>
              <li>Сроки зависят от региона: от 1–2 дней по ближайшим городам.</li>
              <li>Точную стоимость и сроки подтверждает менеджер до отгрузки.</li>
            </ul>
          ...
          <div className="rounded-[var(--radius-md)] border border-line bg-surface p-6">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-ink-soft">
              Способы оплаты и условия предоплаты уточняйте у менеджера при подтверждении заказа —
              он назовёт актуальный порядок расчётов и пришлёт реквизиты.
            </p>
            <p className="mt-4 rounded-[var(--radius-sm)] border border-dashed border-line-strong bg-white px-4 py-3 text-sm leading-relaxed text-ink-muted">
              Конкретные способы оплаты в исходных материалах не указаны. Когда заказчик их
              подтвердит, текст меняется в одном месте — <code>src/app/delivery/page.tsx</code>.
            </p>
        ...
        <section className="mt-14">
          <h2 className="text-[clamp(1.5rem,1.2rem+1.3vw,2.125rem)] leading-tight">Частые вопросы</h2>
